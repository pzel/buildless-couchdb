...
### There is an instance of [CouchDB](https://couchdb.apache.org/) running locally, and the app's PouchDB is set up to replicate to CouchDB.
...
### The Preact component (the App) knows how to shut down cleanly
